...
class AutoEncoder(pl.LightningModule):
    ...
    def cont_step(self, h):
        ...
        if self.cont_loss == "clip":
            ...
            logs['{}_cont_loss_A'.format(self.mode)] = loss_A
            logs['{}_cont_loss_B'.format(self.mode)] = loss_B
            logs['{}_cont_loss_C'.format(self.mode)] = loss_C
            ...
            logs['{}_cont_loss_on_diag'.format(self.mode)] = loss_on_diag
            logs['{}_cont_loss_off_diag'.format(self.mode)] = loss_off_diag
            ...
            logs['{}_cont_loss_num'.format(self.mode)] = loss_num
            logs['{}_cont_loss_den'.format(self.mode)] = loss_den
